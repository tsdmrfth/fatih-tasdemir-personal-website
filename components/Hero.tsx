  ...
  return (
    <section id="hero" className="min-h-screen flex items-center justify-center relative overflow-hidden pt-10">
      ...
      <div className="absolute inset-0 w-full h-full pointer-events-none">
        <div className="absolute top-[20%] left-[5%] w-[150px] sm:w-[300px] h-[150px] sm:h-[300px] bg-cyber-cyan/5 rounded-full blur-[60px] sm:blur-[100px]" />
        <div className="absolute bottom-[20%] right-[5%] w-[200px] sm:w-[400px] h-[200px] sm:h-[400px] bg-cyber-magenta/5 rounded-full blur-[80px] sm:blur-[120px]" />
      </div>
      ...
      <div className="relative z-10 max-w-5xl w-full px-6 flex flex-col items-start">
        ...
        <motion.div
          ...
          <a href={SOCIAL_LINKS.github} target="_blank" rel="noreferrer"
            className="flex-1 sm:flex-none flex items-center justify-center gap-2 px-4 sm:px-6 py-3 bg-white/5 border border-white/10 hover:border-cyber-cyan hover:bg-cyber-cyan/10 hover:text-cyber-cyan transition-all duration-300">
            <Github size={18} />
            <span className="font-mono text-xs sm:text-sm">GITHUB</span>
          </a>
          <a href={SOCIAL_LINKS.linkedin} target="_blank" rel="noreferrer"
            className="flex-1 sm:flex-none flex items-center justify-center gap-2 px-4 sm:px-6 py-3 bg-white/5 border border-white/10 hover:border-cyber-magenta hover:bg-cyber-magenta/10 hover:text-cyber-magenta transition-all duration-300">
            <Linkedin size={18} />
            <span className="font-mono text-xs sm:text-sm">LINKEDIN</span>
          </a>
          <a href={`mailto:${SOCIAL_LINKS.email}`}
            className="w-full sm:w-auto flex items-center justify-center gap-2 px-4 sm:px-6 py-3 bg-white/5 border border-white/10 hover:border-white hover:bg-white/10 transition-all duration-300">
            <Mail size={18} />
