...
export const Hero: React.FC = () => {
  return (
    <section className="min-h-screen flex items-center justify-center relative overflow-hidden pt-20">
      ...
      <div className="relative z-10 max-w-5xl w-full px-6 flex flex-col items-start">
        ...
        <motion.div
          ...
          <a href={SOCIAL_LINKS.linkedin} target="_blank" rel="noreferrer"
            className="flex items-center gap-2 px-6 py-3 bg-white/5 border border-whit e/10 hover:border-cyber-magenta hover:bg-cyber-magenta/10 hover:text-cyber-magenta transition-all duration-300">
            <Linkedin size={20} />
      ...
      <CatMonitor delay={500} />

      {/* Sleeping Cat (Bottom Left - Faded) */}
      <CatMonitor
        type="sleeping"
        className="hidden lg:block fixed left-0 bottom-0 z-40 h-[15vh] w-auto aspect-square pointer-events-none origin-bottom-left"
        opacity={0.3}
        delay={1900}
        sleepEyeScale={0}
      />
      ...
      <CatMonitor
        type="sleeping"
        className="hidden lg:block fixed left-[10%] top-0 z-40 h-[10vh] w-auto aspect-square pointer-events-none origin-center"
        opacity={0.5}
        delay={2700}
      />
    </section>
