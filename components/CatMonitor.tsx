            ...
            <svg
                ...
                <g transform="matrix(1,0,0,1,34.033,49.465)">
                    <g transform="matrix(1,0,0,1,221.967,203.677)">
                        ...
                        {/* The SVG path has 'holes' for eyes. To blink, we need to cover these holes
                  with the skin color (white) from the top down.
                  Coordinates estimated based on the eye holes in the path data:
                  Left Eye Hole approx: x: -122 to -51, y: 27 to 80
                  Right Eye Hole approx: x: 47 to 119, y: 28 to 80
              */}
